    ...
    <div class="container-xl">
        <div class="row">
            <div class="col-md-6 col-lg-3">
                <x-utilities.widget title="Members" subTitle="{{ $members }}" class="bg-azure">
            ...
            <div class="col-md-6 col-lg-3">
                <x-utilities.widget title="Kursus" subTitle="{{ $series }}" class="bg-azure">
            ...
            <div class="col-md-6 col-lg-3">
                <x-utilities.widget title="Articles" subTitle="100" class="bg-azure">
            ...
            <div class="col-md-6 col-lg-3">
                <x-utilities.widget title="Profits" subTitle="Rp. {{ number_format($profits) }}" class="bg-azure">
